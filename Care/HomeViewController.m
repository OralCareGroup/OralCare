...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CTableViewCell *activityCell=(CTableViewCell *)[tableView dequeueReusableCellWithIdentifier:idenfier];
 [activityCell.cImageView sd_setImageWithURL:[NSURL URLWithString:@"http://fa.topit.me/a/88/c3/1131716710238c388ao.jpg"]];
    return activityCell;
